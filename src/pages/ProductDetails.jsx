    ...
    <div className="mt-8 mb-20 px-4 sm:px-8 md:px-12 lg:px-20 mx-auto">
      <div className="flex flex-col items-center gap-2 mb-10">
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary font-bold text-center">
          Product Details of {data.productName}
        </h2>
      ...
      <div>
        ...
        {/* ====================== Product Description ========================= */}
        <div className="mt-10">
            <h3 className="max-[340px]:text-xl text-2xl sm:text-3xl font-bold mt-7 mb-4">Product Full Specification</h3>
            <p className="text-base sm:text-lg font-medium text-gray-400">{data.productDescription}</p>
        </div>
    </div>
  );
};
