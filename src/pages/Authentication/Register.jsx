...
const Register = () => {
  ...
  const onSubmit = (data) => {
    ...
    const userInfo = { name, email, password, confirmPassword, role, cart, wishlist };
  ...
  return (
    <div className=" py-8 px-4 sm:px-8 md:px-12 lg:px-20">
      <div className="flex flex-col lg:flex-row items-center gap-10 shadow-2xl p-10 rounded-xl">
        {/* image */}
